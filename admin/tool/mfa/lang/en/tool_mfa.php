...
$string['setting:course'] = 'Courses';
$string['settings:course_help'] = 'Select Courses';
...
//Blocked users.
$string['heading'] = 'Locked users';
$string['invalidtry'] = 'Invalid try users';
$string['unlockmsg'] = 'User unlock';
$string['lastname'] = 'Last name';
$string['unlockbtn'] = 'Unlock';
$string['unlocknode'] = 'Manage locked users';
$string['cnfunlock'] = 'Are you sure to unlock the user?';
$string['invalidtryusers'] = 'Blocked users';

//Resend auth code
$string['authcodeheading'] = 'Auth codes';
$string['authcodetitle'] = 'Auth codes';
...
$string['resendbtn'] = 'Resend';
$string['searchuser'] = 'Search user';
$string['search'] = 'Search';
$string['mfasubject'] = 'Your confirmation code';
$string['mfamessage'] = '<p>Your confirmation code is {$a->secret}</p>';
$string['resendconfirm'] = 'Are you sure to resend the code?';
$string['confirmationcode'] = 'Confirmation code';

//ignore authentication
$string['ignoreauthheading'] = 'By pass user';
$string['ignoreauthtitle'] = 'By pass user';
$string['ignoreauthconfirm'] = 'Are you sure to by pass this user ?';
$string['city'] = 'City';
$string['country'] = 'Country';
$string['disableauth'] = 'Disable MFA Auth';
$string['enableauth'] = 'Enable MFA Auth';
$string['lastaccess'] = 'Last access';
$string['timecreated'] = 'Created At';
$string['skipuserauth'] = 'Skip user authentication';
$string['skippedusers'] = 'Show MFA authentication skipped users';