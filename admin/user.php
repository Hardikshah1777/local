...
<?php
    ...
    $delete2       = optional_param('delete2', 0, PARAM_INT);
    ...
    if (!empty($delete2)){
        $customurl = new moodle_url('/local/test1/index.php');
    }else{
...
$PAGE->set_primary_active_tab('siteadminnode');
    ...
    if (!$users) {
        ...
        foreach ($users as $user) {
            ...
            $mailurl = new moodle_url('/local/userlist/index.php', ['userid1' => $user->id]);
            $buttons[] = $OUTPUT->action_link($mailurl, '', null, [],new \pix_icon('t/email', 'E-mail'));
