...
class condition extends \core_availability\condition {
    ...
    public function __construct($structure) {
        ...
        if (isset($structure->e) && in_array($structure->e,
            ...
            // Activity available if user get passign grade if passing grade is required for availablr next activity
//            $data = $DB->get_record('course_modules',['id'=>$structure->cm, 'completionpassgrade' => 1]);
//            if (!empty($data->completionpassgrade)){
//                $this->expectedcompletion =  COMPLETION_COMPLETE_PASS;
//            }else{
