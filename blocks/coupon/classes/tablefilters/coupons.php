...
// along with Moodle.  If not, see <http://www.gnu.org/licenses/>.selectgroups
...
class coupons extends filtering {
    ...
    {
        $this->datefield = $baseurl instanceof \moodle_url && $baseurl->get_param('tab') === 'used'?'timeclaimed':'senddate';
        parent::__construct($baseurl, $extraparams, $fieldnames);
    }
...
//            'role' => 1,
    ...
    public function get_field($fieldname, $advanced) {
        switch ($fieldname) {
            ...
            case 'timeclaimed':
                return new \user_filter_date('timeclaimed',
                        get_string('report:timeclaimed', 'block_coupon'), $advanced, 'c.timeclaimed');
            case 'senddate':
