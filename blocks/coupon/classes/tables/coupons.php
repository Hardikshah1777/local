...
class coupons extends \table_sql {
    ...
    public function out($pagesize, $useinitialsbar, $downloadhelpbutton='') {
        if ($this->columns && \block_coupon\helper::get_access() < ADMIN_ACCESS && array_key_exists('action',$this->columns)) {
	...
	public function get_sort_columns()
    {
		...
		if($this->filter == self::USED) $sort['timeclaimed'] = SORT_DESC;
        $sort['timecreated'] = SORT_DESC;
        return $sort;
    }
	//////////////////////////////////EE
