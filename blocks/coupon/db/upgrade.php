...
function xmldb_block_coupon_upgrade($oldversion) {
    ...
    if ($oldversion < 2018050307) {

        $table = new xmldb_table('block_coupon_group_pricing');
        $table->add_field('id', XMLDB_TYPE_INTEGER, '6', XMLDB_UNSIGNED, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('groupid', XMLDB_TYPE_INTEGER, '6', null, XMLDB_NOTNULL, null, null, 'id');
        $table->add_field('courseid', XMLDB_TYPE_INTEGER, '6', null, XMLDB_NOTNULL, null, null, 'groupid');
        $table->add_field('price', XMLDB_TYPE_INTEGER, '6', null, XMLDB_NOTNULL, null, null, 'couponid');
        // Add KEYS.
        $table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));
        ...
        $table = new xmldb_table('block_coupon_purchase_info');
        $table->add_field('id', XMLDB_TYPE_INTEGER, '6', XMLDB_UNSIGNED, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('userid', XMLDB_TYPE_INTEGER, '6', null, XMLDB_NOTNULL, null, null, 'id');
        $table->add_field('groupid', XMLDB_TYPE_INTEGER, '6', null, XMLDB_NOTNULL, null, null, 'userid');
        $table->add_field('courseid', XMLDB_TYPE_INTEGER, '6', null, XMLDB_NOTNULL, null, null, 'groupid');
        $table->add_field('quantity', XMLDB_TYPE_INTEGER, '6', null, XMLDB_NOTNULL, null, null, 'courseid');
        $table->add_field('txn_id', XMLDB_TYPE_CHAR, '100', null, XMLDB_NOTNULL, null, null, 'quantity');
        $table->add_field('payer_email', XMLDB_TYPE_CHAR, '100', null, XMLDB_NOTNULL, null, null, 'txn_id');
        $table->add_field('payment_gross', XMLDB_TYPE_INTEGER, '6', null, XMLDB_NOTNULL, null, null, 'payer_email');
        $table->add_field('payment_status', XMLDB_TYPE_CHAR, '100', null, XMLDB_NOTNULL, null, null, 'payment_gross');
        $table->add_field('used', XMLDB_TYPE_INTEGER, '6', null, XMLDB_NOTNULL, null, 0, 'payment_status');
        $table->add_field('timemodified', XMLDB_TYPE_INTEGER, '18', null, XMLDB_NOTNULL, null, null, 'used');
        // Add KEYS.
        $table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));
        ...
        upgrade_block_savepoint(true, 2018050307, 'coupon');
    }
    return true;
}
