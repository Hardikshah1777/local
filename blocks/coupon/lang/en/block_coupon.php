...
$string['report:timeclaimed'] = 'Claimed date';//raju
...
$string['th:for_user_name'] = 'Recipient name';
...
////////////////
$string['error:same_coupon_email_exist'] = 'Coupon already created for this email. Please delete old coupon first.';

//form:group_pricing
$string['form:group_pricing:price'] = 'Price';

//page:generate_coupon
$string['page:generate_coupon:title'] = 'Create Coupons';
$string['purchase:heading:index'] = '';
$string['purchase:heading:quantity'] = 'No. of Coupons';
$string['purchase:heading:used'] = 'No. of Coupons Used';
$string['purchase:heading:coursename'] = 'Course';
$string['purchase:heading:payment_gross'] = 'Payment';
$string['purchase:heading:payer_email'] = 'Paypal Email';
$string['purchase:heading:fullname'] = 'Firstname / Lastname';

//table:group_pricing.php
$string['tab:cpgrouppricing'] = 'Group Pricing';
$string['view:group_pricing:title'] = 'Group Pricing';
$string['view:group_pricing:heading'] = 'Group Pricing';
$string['page:group_pricing:redirectmsg'] = 'Price set successfully';
$string['report:heading:name'] = 'Groupname';
$string['report:heading:price'] = 'Price';
$string['table:group_pricing:editlabel'] = 'Edit';

//form:generator_paypal
$string['form:generator_paypal:courselabel'] = 'Course';
$string['form:generator_paypal:quantitylabel'] = 'No. of Coupons';
$string['button:paypal'] = 'Pay now';

//table:paypal
$string['paypal:heading:index'] = '';
$string['paypal:heading:quantity'] = 'No. of Coupons';
$string['paypal:heading:used'] = 'No. of Coupons Used';
$string['paypal:heading:coursename'] = 'Course';
$string['paypal:heading:action'] = 'Action';
$string['paypal:heading:payment_gross'] = 'Payment';
$string['table:paypal:editlabel'] = 'Create Coupons';

//form:generator_email
$string['page:generate_email:title'] = 'Generate Emails';
$string['view:generate_email:title'] = 'Generate Emails';
$string['view:generate_email:heading'] = 'Generate Emails';
$string['view:generate_email:notsameuser'] = 'You can not proceed';
$string['view:generate_email:noremaining'] = 'You have no coupons left';
$string['button:generator_email'] = 'Send Coupons';
$string['form:generator_email:coupon_recipients_desc'] = 'Add comma separated emails';
$string['form:generator_email:remainingnote'] = 'You have {$a} coupons left.';
$string['error:generator_email:recipients-empty'] = 'Please input comma seperated emails';
$string['error:generator_email:recipients-max-exceeded'] = 'You have exceeded the maximum available coupons. You have only {$a} coupons left.';
$string['error:generator_email:recipients-email-invalid'] = '';
$string['page:generate_email:successmsg'] = 'Coupons created successfully';

//ipn
$string['ipn:successmsg'] = 'Payment Successful';

//settings
$string['paypalsettings'] = 'Payment settings';
$string['paypalsettings_desc'] = 'Here you can configure payment credentials';
$string['label:coupon_paypalemail'] = 'Paypal business email';
$string['label:coupon_paypalemail_desc'] = 'Enter paypal email which receives payment';
$string['label:coupon_usepaypalsandbox'] = 'Enable paypal sandbox';
$string['label:coupon_usepaypalsandbox_desc'] = 'Use paypal sandbox or not (this is for testing purpose)';

$string['tab:cppurchasehistory'] = 'Purchase history';
