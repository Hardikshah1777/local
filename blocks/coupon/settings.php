...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_heading('block_coupon_paypalsettings',
            get_string('paypalsettings', 'block_coupon'),
            get_string('paypalsettings_desc', 'block_coupon', $header)));
    $settings->add(new admin_setting_configtext('block_coupon/coupon_paypalemail',
            get_string('label:coupon_paypalemail', 'block_coupon'),
            get_string('label:coupon_paypalemail_desc', 'block_coupon'),
            ''
    ));
    $settings->add(new admin_setting_configcheckbox('block_coupon/coupon_usepaypalsandbox',
            get_string('label:coupon_usepaypalsandbox', 'block_coupon'),
            get_string('label:coupon_usepaypalsandbox_desc', 'block_coupon'),
            0
    ));
