...
$PAGE->navbar->add(get_string('page:generate_coupon:title', 'block_coupon'));
...
if(helper::get_access() >= MANAGER_ACCESS) echo $renderer->page_coupon_generator_singlestep(true);
else echo $renderer->page_coupon_generator_paypal();
