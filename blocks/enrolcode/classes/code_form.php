...
class code_form extends moodleform {
    ...
    function definition() {
        ...
        if (count($oldcodes) > 0) {
            $mform->addElement('html', "<a href=\"#\" class=\"btn btn-primary\" onclick=\"$('#block_enrolcode_old_codes-" . $uniqid . "').toggleClass('hidden'); return false;\" style=\"margin-left: 10px;\">" . get_string('show_existing_codes', 'block_enrolcode') . "</a>");
        }
