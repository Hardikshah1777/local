...
class course_edit_form extends moodleform {
    ...
    function definition() {
        ...
        //Max student.
        $mform->addElement('text','maxstudent', get_string('maxstudent'),'maxlength="100"  size="10"');
        $mform->addHelpButton('maxstudent', 'maxstudent');
        $mform->setType('maxstudent', PARAM_INT);

        $options = ['optional' => true];
        $mform->addElement('duration','duration', get_string('duration', 'block_temco_dashboard'), $options);
