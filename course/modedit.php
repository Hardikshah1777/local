...
if (!empty($add)) {
    ...
    file_prepare_standard_filemanager($data, 'activityicon', ['maxfiles' => 1, 'accepted_types' => 'image'],
        $context, 'course', 'activityicon', 0);
...
if ($mform->is_cancelled()) {
    ...
    file_postupdate_standard_filemanager($fromform, 'activityicon', ['maxfiles' => 1, 'accepted_types' => 'image'],
        context_module::instance($fromform->coursemodule), 'course', 'activityicon', 0);
