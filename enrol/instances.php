...
$maxstudent = $DB->get_record('course', ['id' => $course->id], 'maxstudent');
if (!empty($maxstudent->maxstudent)) {
    $numberofstudent = get_string('displaymaxstudent', 'moodle', $maxstudent);
    echo html_writer::tag('span', $numberofstudent, ['class' => 'float-right mt-2']);
}
