/**
 * @module local_squibit/user_filterform
 */
...
var SELECTORS = {
    filterform: '#userfilterform form',
    table: '#region-main table',
    save: '#userfilter',
    cancel: '#canceluserfilter',
};
...
export const initTable = () => {
        ...
        const submitHandler = e => {
            ...
            e.preventDefault();
            var table = DynamicTable.getTableFromId("users");
        ...
        const cancelHandler = e => {
            ...
            e.preventDefault();
            var form = document.querySelector(SELECTORS.filterform);
            var tableRoot = DynamicTable.getTableFromId("users");
