...
use local_userstatus\participants_table;
...
$renderer = $PAGE->get_renderer('local_userstatus', 'user');
...
$participanttable = new participants_table($course->id, $groupid, $lastaccess, $roleid, $enrolid, $status,
