...
/**
 * This file contains an event for when a student's behaviour report is viewed.
 *
...
/**
 * Event for when a student's behaviour report is viewed.
 *
 * @property-read array $other {
 *      Extra information about event properties.
 *
 *      string studentid Id of student whose behaviours were viewed.
...
class session_report_viewed extends \core\event\base {
    ...
    public function get_description() {
        return 'User with id ' . $this->userid . ' ' . $this->action . ' behaviour sessions for student with id ' .
            $this->relateduserid;
    }
    ...
    public static function get_name() {
        return get_string('eventstudentbehavioursessionsviewed', 'mod_behaviour');
    }
    ...
    public function get_url() {
        ...
        return new \moodle_url('/mod/behaviour/view.php', array('id' => $this->contextinstanceid,
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'behaviour', 'student sessions ' . $this->action, $this->get_url(),
