...
class filter_controls implements renderable {
     ...
     * @param bool $report
     */
    public function __construct(mod_behaviour_structure $att, $report = false) {
        global $PAGE;
        ...
        // This is a report control only if $reports is true and the behaviour block can be graded.
        ...
        switch ($this->pageparams->view) {
            case ATT_VIEW_DAYS:
                $format = get_string('strftimedm', 'behaviour');
