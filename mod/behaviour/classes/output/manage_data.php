...
/**
 * Represents info about behaviour sessions taking into account view parameters.
 *
...
class manage_data implements renderable {
    ...
    public $att;
    /**
     * Prepare info about behaviour sessions taking into account view parameters.
     *
     * @param mod_behaviour_structure $att instance
     */
