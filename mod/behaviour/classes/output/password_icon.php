...
/**
 * Data structure representing an behaviour password icon.
 *
...
class password_icon implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $title = get_string('password', 'behaviour');
        ...
        $data->alt = $title;
        $data->icon = (new pix_icon($pix, '', 'behaviour'))->export_for_template($output);
        $data->linktext = '';
        $data->title = $title;
        $data->url = (new moodle_url('/mod/behaviour/password.php', [
