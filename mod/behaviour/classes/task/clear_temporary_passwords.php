...
/**
 * behaviour task - clear temporary passwords.
 *
...
class clear_temporary_passwords extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('rotateqrcode_cleartemppass_task', 'mod_behaviour');
    }
    ...
    public function execute() {
        ...
        $DB->delete_records_select('behaviour_rotate_passwords', 'expirytime < :currenttime', $params);
    }
}
