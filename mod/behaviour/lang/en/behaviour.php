...
/**
 * Strings for component 'behaviour', language 'en'
 *
...
$string['behaviour:addinstance'] = 'Add a new behaviour activity';
$string['behaviour:manualautomark'] = 'Allow manual auto-marking process';
$string['behaviour:canbelisted'] = 'Appears in the roster';
$string['behaviour:changebehaviours'] = 'Changing behaviours';
$string['behaviour:changepreferences'] = 'Changing Preferences';
$string['behaviour:export'] = 'Export Reports';
$string['behaviour:import'] = 'Import sessions from file (csv)';
$string['behaviour:managebehaviours'] = 'Manage Behaviours';
$string['behaviour:managetemporaryusers'] = 'Manage temporary users';
$string['behaviour:takebehaviours'] = 'Taking Behaviours';
$string['behaviour:view'] = 'Viewing Behaviours';
$string['behaviour:viewreports'] = 'Viewing Reports';
$string['behaviour:viewsummaryreports'] = 'View course summary reports';
$string['behaviour:warningemails'] = 'Can be subscribed to emails with absentee users';
$string['behaviour_already_submitted'] = 'Your Behaviour has already been set.';
$string['behaviour_no_status'] = 'No valid status was available - you may be too late to record behaviour.';
$string['behaviourdata'] = 'Behaviour data';
$string['behaviourfile'] = 'Behaviour file (csv format)';
$string['behaviourfile_help'] = 'The file must be a CSV file with a header row and fields for identifying the user and the time behaviour was recorded eg (email,scantime) or (username,time)';
$string['behaviourgrade'] = 'Behaviour grade';
$string['behaviournotset'] = 'You must set your behaviour';
$string['behaviournotstarted'] = 'Behaviour has not started yet for this course';
$string['behaviourpercent'] = 'Behaviour percent';
$string['behaviourreport'] = 'Behaviour';
$string['behaviouruserreport'] = 'Behaviour report';
$string['behaviourslogged'] = 'Behaviours logged';
$string['behaviourstaken'] = 'Behaviours taken';
$string['behavioursuccess'] = 'Behaviour has been successfully taken';
$string['behaviourupdated'] = 'Behaviour successfully updated';
...
$string['attrecords'] = 'Behaviours records';
...
If "Set unmarked at end of session" any students who have not marked their behaviour will be set to the unmarked status selected.';
...
$string['automarktask'] = 'Check for behaviour sessions that require auto marking';
$string['automarkingcomplete'] = 'Automatic marking complete';
$string['autorecorded'] = 'system auto recorded';
$string['averagebehaviour'] = 'Average behaviour';
$string['averagebehaviourgraded'] = 'Average behaviour';
...
$string['cannottakeforgroup'] = 'You can\'t take behaviour for group "{$a}"';
$string['cantaddstatus'] = 'You must set an acronym and description when adding a new status.';
$string['canthidestatus'] = 'You cannot hide this status because it is already in use within this behaviour activity';
$string['categoryreport'] = 'Course category report';
$string['changebehaviour'] = 'Change behaviour';
...
$string['confirmdeleteuser'] = 'Are you sure you want to delete user \'{$a->fullname}\' ({$a->email})?<br/>All of their behaviour records will be permanently deleted.';
$string['copyfrom'] = 'Copy behaviour data from';
...
The sessions begin on the date of the base session and continue until the \'repeat until\' date.
  ...
  * <strong>Repeat until</strong>: Select the last day of class (the last day you want to take behaviour).
';
...
$string['defaultsettings'] = 'Default behaviour settings';
$string['defaultsettings_help'] = 'These settings define the defaults for all new behaviours';
$string['defaultstatus'] = 'Default status set';
$string['defaultsubnet'] = 'Default network address';
$string['defaultsubnet_help'] = 'Behaviour recording may be restricted to particular subnets by specifying a comma-separated list of partial or full IP addresses. This is the default value used when creating new sessions.';
...
$string['deletelogs'] = 'Delete behaviour data';
...
Your behaviour in %coursename% %behaviourname% has dropped below %warningpercent% and is currently %percent% - we hope you are ok!

To get the most out of this course you should improve your behaviour, please get in touch if you require any further support.';
...
$string['emailsubject_default'] = 'Behaviour warning';
...
$string['enablecalendar_desc'] = 'If enabled, a calendar event will be created for each behaviour session. After changing this setting you should run the reset calendar report.';
$string['enablewarnings'] = 'Enable warnings';
$string['enablewarnings_desc'] = 'This allows a warning set to be defined for an behaviour and email notifications to users when behaviour drops below the configured threshold. <br/><strong>WARNING: This is a new feature and has not been tested extensively. Please use at your own-risk and provide feeback in the moodle forums if you find it works well.</strong>';
...
$string['error:coursehasnobehaviour'] = 'The course with the short name {$a} has no behaviour activities.';
$string['error:coursenotfound'] = 'A course with the short name {$a} can not be found.';
$string['error:qrcode'] = 'Allow students to record own behaviour must be enabled to use QR code! Skipping.';
...
$string['eventreportviewed'] = 'Behaviour report viewed';
...
$string['eventsessionipshared'] = 'Behaviour self-marking IP conflict';
...
$string['eventstudentbehavioursessionsviewed'] = 'Session report viewed';
$string['eventstudentbehavioursessionsupdated'] = 'Session report updated';
$string['eventtaken'] = 'Behaviour taken';
$string['eventtakenbystudent'] = 'Behaviour taken by student';
...
$string['gradebookexplanation_help'] = 'The Behaviour module displays your current behaviour grade based on the number of points you have earned to date and the number of points that could have been earned to date; it does not include class periods in the future. In the gradebook, your behaviour grade is based on your current behaviour percentage and the number of points that can be earned over the entire duration of the course, including future class periods. As such, your behaviour grades displayed in the Behaviour module and in the gradebook may not be the same number of points but they are the same percentage.

For example, if you have earned 8 of 10 points to date (80% behaviour) and behaviour for the entire course is worth 50 points, the Behaviour module will display 8/10 and the gradebook will display 40/50. You have not yet earned 40 points but 40 is the equivalent point value to your current behaviour percentage of 80%. The point value you have earned in the Behaviour module can never decrease, as it is based only on behaviour to date; however, the behaviour point value shown in the gradebook may increase or decrease depending on your future behaviour, as it is based on behaviour for the entire course.';
...
$string['incorrectpassword'] = 'You have entered an incorrect password and your behaviour has not been recorded, please enter the correct password.';
$string['incorrectpasswordshort'] = 'Incorrect password, behaviour not recorded.';
$string['indetail'] = 'In detail...';
$string['indicator:cognitivedepth'] = 'Behaviour cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in an Behaviour activity.';
$string['indicator:cognitivedepthdef'] = 'Behaviour cognitive';
$string['indicator:cognitivedepthdef_help'] = 'The participant has reached this percentage of the cognitive engagement offered by the Behaviour during this analysis interval (Levels = No view, View)';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadth'] = 'Behaviour social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in an Behaviour activity.';
$string['indicator:socialbreadthdef'] = 'Behaviour social';
$string['indicator:socialbreadthdef_help'] = 'The participant has reached this percentage of the social engagement offered by the Behaviour during this analysis interval (Levels = No participation, Participant alone)';
...
$string['modulename'] = 'Behaviour';
$string['modulename_help'] = 'The behaviour activity module enables a teacher to take behaviour during class and students to view their own behaviour record.

The teacher can create multiple sessions and can mark the behaviour status as "Present", "Absent", "Late", or "Excused" or modify the statuses to suit their needs.

Reports are available for the entire class or individual students.';
$string['modulenameplural'] = 'Behaviours';
$string['months'] = 'Months';
$string['morebehaviour'] = 'Behaviour has been successfully taken for this page';
...
$string['nobehaviourusers'] = 'It is not possible to export any data as there are no students enrolled in the course.';
$string['noattforuser'] = 'No behaviour records exist for the user';
$string['noautomark'] = 'Disabled';
$string['nocapabilitytotakethisbehaviour'] = 'You tried to change the behaviour of a session with the cmid: {$a} that you do not have permission to modify.';
...
$string['noguest'] = 'Guest can\'t see behaviour';
...
$string['notfound'] = 'Behaviour activity not found in this course!';
$string['notifytask'] = 'Send warnings to users';
$string['notmember'] = 'not&nbsp;member';
$string['notset'] = 'not set';
$string['noupgradefromthisversion'] = 'The Behaviour module cannot upgrade from the version of attforblock you have installed. - please delete attforblock or upgrade it to the latest version before isntalling the new behaviour module';
...
$string['oversessionstaken_help'] = 'Shows statistics for sessions where behaviour has been taken:
    <ul>
...
$string['passwordheader'] = 'Use the password listed below to take your behaviour';
$string['passwordgrp'] = 'Student password';
$string['passwordgrp_help'] = 'If set students will be required to enter this password before they can set their own behaviour status for the session. If empty, no password is required.';
$string['passwordrequired'] = 'You must enter the session password before you can submit your behaviour';
...
$string['pluginadministration'] = 'Behaviour administration';
$string['pluginname'] = 'Behaviour';
$string['points'] = 'Points';
$string['pointsallsessions'] = 'Points over all sessions';
$string['pointssessionscompleted'] = 'Points over taken sessions';
$string['preferences_desc'] = 'Changes to status sets will affect existing behaviour sessions and may affect grading.';
$string['preventsharederror'] = 'Self-marking has been disabled for a session because this device appears to have been used to record behaviour for another student.';
$string['preventsharedip'] = 'Prevent students sharing IP address';
$string['preventsharedip_help'] = 'Prevent students from using the same device (identified using IP address) to take behaviour for other students.';
$string['preventsharediptime'] = 'Time to allow re-use of IP address (minutes)';
$string['preventsharediptime_help'] = 'Allow an IP address to be re-used for taking behaviour in this session after this time has elapsed.';
...
$string['privacy:metadata:behaviourlog'] = 'Log of user behaviours recorded.';
$string['privacy:metadata:behavioursessions'] = 'Sessions to which behaviour will be recorded.';
$string['privacy:metadata:behaviourwarningdone'] = 'Log of warnings sent to users over their behaviour record.';
...
$string['privacy:metadata:ipaddress'] = 'IP address behaviour was marked from.';
$string['privacy:metadata:lasttaken'] = 'Timestamp of when session behaviour was last taken.';
$string['privacy:metadata:lasttakenby'] = 'User ID of the last user to take behaviour in this session';
$string['privacy:metadata:notifyid'] = 'ID of behaviour session warning is associated with.';
$string['privacy:metadata:remarks'] = 'Comments about the user\'s behaviour.';
$string['privacy:metadata:sessdate'] = 'Timestamp of when session starts.';
$string['privacy:metadata:sessionid'] = 'Behaviour session ID.';
$string['privacy:metadata:statusid'] = 'ID of student\'s behaviour status.';
$string['privacy:metadata:statusset'] = 'Status set to which status ID belongs.';
$string['privacy:metadata:studentid'] = 'ID of student having behaviour recorded.';
$string['privacy:metadata:takenby'] = 'User ID of the user who took behaviour for the student.';
...
$string['privacy:metadata:timetaken'] = 'Timestamp of when behaviour was taken for the student.';
...
$string['requiredentries'] = '  Temporary records overwrite participant behaviour records';
$string['requiredentry'] = '  Temporary user merge help guide';
$string['requiredentry_help'] = '<p align="center"><b>Behaviour</b></p>
...
<tr>
<td>No behaviour data</td>
<td>Behaviour data</td>
<td>Temporary user behaviour will be transfered to Moodle user</td>
</tr>
<tr>
<td>Behaviour data</td>
<td>No behaviour data</td>
...
$string['requiresubnet_help'] = 'Behaviour recording may be restricted to particular subnets by specifying a comma-separated list of partial or full IP addresses.';
...
$string['resetdescription'] = 'Remember that deleting behaviour data will erase information from database. You can just hide older sessions having changed start date of course!';
...
$string['save'] = 'Save behaviour';
$string['saveandshownext'] = 'Save and show next page';
$string['scantime'] = 'Scan time';
$string['scantime_help'] = 'This allows a timestamp to be included in the import file - it will attempt to convert the timestamp passed using the PHP strtotime function and then use behaviour status settings to decide which status to set for the user';
$string['search:activity'] = 'Behaviour - activity information';
...
$string['sessionduplicate'] = 'A duplicate session exists for course: {$a->course} in behaviour: {$a->activity}, {$a->date}';
...
$string['sessionsbyactivity'] = 'Behaviour instance';
...
$string['setunmarked_help'] = 'If enabled in the session, set this status if a student has not marked their own behaviour.';
...
$string['showsessiondescriptiononreport_desc'] = 'Show the session description in the behaviour report listing.';
...
$string['studentavailability_help'] = 'When students are marking their own behaviour, the number of minutes after session starts that this status is available.
 <br/>If empty, this status will always be available, If set to 0 it will always be hidden to students.';
$string['studentid'] = 'Student ID';
$string['studentmarked'] = 'Your behaviour in this session has been recorded.';
...
$string['studentsearlyopentime_help'] = 'This allows teachers to open the session early, alowing for behaviour to be taken before the real start time.';
$string['studentscanmark'] = 'Allow students to record own behaviour';
$string['studentscanmark_desc'] = 'If checked, teachers will be able to allow students to mark their own behaviour.';
$string['studentscanmark_help'] = 'If checked students will be able to change their own behaviour status for the session.';
$string['studentscanmarksessiontime'] = 'Students record behaviour during session time';
$string['studentscanmarksessiontime_desc'] = 'If checked students can only record their behaviour during the session.';
$string['studentscanmarksessiontimeend'] = 'Session end (minutes)';
$string['studentscanmarksessiontimeend_desc'] = 'If the session does not have an end time, how many minutes should the session be available for students to record their behaviour.';
$string['submit'] = 'Submit';
$string['submitbehaviour'] = 'Submit behaviour';
$string['submitpassword'] = 'Submit password';
$string['subnet'] = 'Subnet';
$string['subnetactivitylevel'] = 'Allow subnet config at activity level';
$string['subnetactivitylevel_desc'] = 'If enabled, teachers can override the default subnet at the activity level when creating an behaviour. Otherwise the site default will be used when creating a session.';
$string['subnetwrong'] = 'Behaviour can only be recorded from certain locations, and this computer is not on the allowed list.';
$string['summary'] = 'Summary';
$string['tablerenamefailed'] = 'Rename of old attforblock table to behaviour failed';
$string['tactions'] = 'Action';
$string['takebehaviour'] = 'Take behaviour';
...
$string['thirdpartyemails_help'] = 'List of other users who will be notified. (requires the capability mod/behaviour:viewreports)';
$string['thirdpartyemailsubject'] = 'Behaviour warning';
$string['thirdpartyemailtext'] = '{$a->firstname} {$a->lastname} behaviour within {$a->coursename} {$a->aname} is lower than {$a->warningpercent} ({$a->percent})';
...
$string['time'] = 'Time';
$string['qrcodeheader'] = 'Scan the QR code below to take your behaviour';
$string['qrcodeandpasswordheader'] = 'Scan the QR code below or use the password listed below to take your behaviour';
...
$string['uploadbehaviour'] = 'Upload behaviour by CSV';
...
$string['warnafter_help'] = 'Warnings will only be triggered when the user has had their behaviour taken for at least this number of sessions.';
$string['warningdeleted'] = 'Warning deleted';
$string['warningdesc'] = 'These warnings will be automatically added to any new behaviour activities. If more than one warning is triggered at exactly the same time, only the warning with the lower warning threshold will be sent.';
...
$string['lasttaken'] = 'Behaviours last taken';
$string['timemodified'] = 'Time modified';
$string['name'] = 'Name';
$string['timetaken'] = 'Time behaviour taken';
...
$string['cannottakethisgroup'] = 'You are not a member of the course group that this behaviour session relates to, your behaviour has not been recorded.';
