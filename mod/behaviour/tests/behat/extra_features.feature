@mod @mod_behaviour
Feature: Test the various new features in the behaviour module
  ...
  Background:
    Given the following "courses" exist:
      ...
      | Course 2 | C2        | Prove the behaviour activity works | 0        | ##yesterday## | ##yesterday## |
  ...
  Scenario: A teacher can create and update temporary users
    Given I am on the "Test behaviour" "mod_behaviour > View" page logged in as "teacher1"
  ...
  @javascript
  Scenario: A teacher can take behaviour for temporary users
    Given I am on the "Test behaviour" "mod_behaviour > View" page logged in as "teacher1"
    And I click on "More" "link" in the ".secondary-navigation" "css_element"
    And I select "Temporary users" from secondary navigation
    And I set the following fields to these values:
    ...
    And I set the following fields to these values:
      ...
      | Email     | tempuser2@example.com |
    And I press "Add user"
    And I am on the "Test behaviour" "mod_behaviour > View" page
    And I click on "Add session" "button"
    And I set the following fields to these values:
      | id_addmultiply | 0 |
    And I click on "submitbutton" "button"

    And I follow "Take behaviour"
    # Present
    ...
    And I am on the "Test behaviour" "mod_behaviour > Report" page
  ...
  Scenario: A teacher can select a subset of users for export
    ...
    And I am on the "Test behaviour" "mod_behaviour > View" page logged in as "teacher1"
    And I click on "Add session" "button"
    And I set the following fields to these values:
      | id_addmultiply | 0 |
    And I click on "submitbutton" "button"
  ...
  Scenario: A teacher can create and use multiple status lists
    ...
    When I click on "Take behaviour" "link" in the "10AM" "table_row"
    ...
    And I am on the "Test behaviour" "mod_behaviour > View" page
    And I click on "Take behaviour" "link" in the "12PM" "table_row"
    Then "Set status to «Great»" "link" should exist
    And "Set status to «OK»" "link" should exist
    And "Set status to «Bad»" "link" should exist

  @javascript
  Scenario: A teacher can use the radio buttons to set behaviour values for all users
    Given I am on the "Test behaviour" "mod_behaviour > View" page logged in as "teacher1"
    And I click on "Add session" "button"
    And I set the following fields to these values:
      | id_addmultiply | 0 |
    And I click on "submitbutton" "button"
    And I click on "Take behaviour" "link"
  ...
  @javascript
  Scenario: A teacher can use the radio buttons to set behaviour values for unselected users
    Given I am on the "Test2behaviour" "mod_behaviour > View" page logged in as "teacher1"
    And I click on "Add session" "button"
    And I set the following fields to these values:
      | id_addmultiply | 0 |
    And I click on "submitbutton" "button"
    ...
    And I press "Save and show next page"
    And I am on the "Test2behaviour" "mod_behaviour > Report" page
