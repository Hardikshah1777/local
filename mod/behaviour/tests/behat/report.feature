...
Feature: Visiting reports
  ...
  Scenario: Teacher takes behaviour
    Given I am logged in as "teacher1"
    And I am on the "behaviour" "behaviour activity editing" page
    ...
    When I follow "behaviour"
    Then I click on "Take behaviour" "link" in the "1AM - 2AM" "table_row"
    # Late
  ...
  Scenario: Teacher take behaviour of group session
    ...
    And I press "Save and display"
    And I am on the "behaviour" "mod_behaviour > View" page
    Then I click on "Take behaviour" "link" in the "1AM - 2AM" "table_row"
    # Excused
    And I click on "td.cell.c4 input" "css_element" in the "Student 1" "table_row"
    And I press "Save and show next page"
    ...
    When I click on "Take behaviour" "link" in the "3AM - 4AM" "table_row"
    # Present
  ...
  Scenario: Teacher visit summary report and absentee report
    ...
    And I press "Save and display"
    And I am on the "behaviour" "mod_behaviour > View" page
    When I click on "Take behaviour" "link" in the "1AM - 2AM" "table_row"
    # Late
  ...
  Scenario: Student visit user report
    ...
    Then I log out
    Given I am on the "behaviour" "mod_behaviour > View" page logged in as "student1"
