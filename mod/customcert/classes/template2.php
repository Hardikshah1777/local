...
class template {
     ...
     */
    public function __construct($template, $downloadowncert) {
        $this->id = $template->id;
        $this->name = $template->name;
        $this->contextid = $template->contextid;
        $this->downloadowncert = $downloadowncert;
    }
	...
	public function generate_pdf_others(bool $preview = false, int $userid = null, bool $return = false) {
        global $CFG, $DB, $USER;
