...
namespace customcertelement_userqrcode;
...
class element extends \mod_customcert\element {
    ...
    public function render_form_elements($mform) {
        ...
        $mform->addElement('text', 'height', get_string('height', 'customcertelement_userqrcode'), array('size' => 10));
        $mform->setType('height', PARAM_INT);
        $mform->setDefault('height', 0);
        $mform->addHelpButton('height', 'height', 'customcertelement_userqrcode');
    ...
    public function render($pdf, $preview, $user) {
        ...
        if ($preview) {
            ...
            // Generate the URL to verify this.
            $qrcodeurl = new \moodle_url('/login/index.php',
                [
