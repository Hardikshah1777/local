...
$string['grade'] = 'Final Score';
$string['duration'] = 'Study Time';

$string['userdetail'] = 'User detail';
$string['courseresult'] = 'Course and result';
$string['coursedescription'] = 'Course Details';
$string['modulesection'] = 'Modules Studied';
$string['course'] = 'Course';
$string['module'] = 'Module {$a}';
$string['certno'] = 'Cert No:';
$string['downloadlink'] = 'Download';
$string['coursestarted'] = 'Course Started on: ';
$string['trainingreceivedon'] = 'Refresher training received on {$a}';
$string['trainingdueon'] = 'Course refresher training is due on {$a}';
