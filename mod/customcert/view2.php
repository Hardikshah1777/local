...
if (!$downloadown && !$downloadissue && !$getissue && !$downloadownn && !$printcert) {
    ...
    if (!empty($downloadownn)){
        $template = new \mod_customcert\template($template, $downloadownn);
    }else if (!empty($printcert)){
        $template = new \mod_customcert\template($template, $printcert);
    }else{
