...
/**
 * mod_evaluation external function
 *
 * @package    mod_evaluation
...
class mod_evaluation_external extends external_api {
    ...
    /**
     * Parameters for the 'mod_evaluation_invoke_move_action' WS
    ...
    public static function invoke_move_action_parameters() {
        ...
        $sectionfileds = [
          ...
          'saferid' => new external_value(PARAM_BOOL, 'Section Saferid', VALUE_OPTIONAL),
        ];
    ...
    /**
     * WS 'mod_evaluation_invoke_move_action' that invokes a move action
     *
     * @param string $action
     * @param array $data
     * @param int $position
    ...
    public static function invoke_move_action($action,$data) {
        ...
        foreach ($data as $value){
            ...
            $updatedata->saferskill = $value['saferid'];
            $update = $DB->update_record('evaluation_section',$updatedata);
        }
    }

    /**
     * Return structure for the 'mod_evaluation_invoke_move_action' WS
     * @return null
     */
