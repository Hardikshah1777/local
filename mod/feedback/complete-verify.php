...
$PAGE->set_url('/mod/feedback/complete-verify.php', $urlparams);
...
if (trim(str_replace($CFG->wwwroot, '', get_local_referer()), '/') === 'demo1.php') {
    $PAGE->add_body_class('feedback-inframe');
}
...
?>
<style>
    #page-mod-feedback-complete-verify .page-context-header {
        display: none;
    }

    #page-mod-feedback-complete-verify header#page-header {
        display: none;
    }

    #page-mod-feedback-complete-verify #page.drawers .activity-header {
        display: none;
    }

    #page-mod-feedback-complete-verify nav.navbar{
        display: none;
    }

    #page-mod-feedback-complete-verify .drawer.drawer-left {
        display: none;
    }

    #page-mod-feedback-complete-verify .drawer-toggles .drawer-left-toggle {
        display: none;
    }
    #page-mod-feedback-complete-verify .continuebutton form {
        display: none;
    }
