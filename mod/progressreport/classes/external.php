...
/**
 * mod_progressreport external function
 *
 * @package    mod_progressreport
 * @copyright  2018 Moodle
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_progressreport_external extends external_api {

    /**
     * Parameters for the 'mod_progressreport_invoke_move_action' WS
    ...
    /**
     * WS 'mod_progressreport_invoke_move_action' that invokes a move action
     *
     * @param string $action
     * @param array $data
     * @param int $position
    ...
    public static function invoke_move_action($action,$data) {
        ...
        foreach ($data as $value){
            ...
            $update = $DB->update_record('progressreport_section',$updatedata);
        }
    }

    /**
     * Return structure for the 'mod_progressreport_invoke_move_action' WS
     * @return null
     */
