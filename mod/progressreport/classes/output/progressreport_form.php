...
class progressreport_form implements renderable, templatable{
    ...
    public $progressreportname;

    public $progressreporturl;
    ...
    public function set_progressreportdata(array $progressreportdata) {
        $this->progressreportdata = $progressreportdata;
        return $this;
    }

    public function get_progressreportdata(){
    ...
    public function export_for_template(renderer_base $output) {
        global $OUTPUT,$DB;
        $result = new stdClass();
        $result->progressrepotid = $this->progressreportid;
        $result->name = $this->progressreportname;
        $result->url = $this->progressreporturl;
        $result->userid = $this->userid;
        $result->progressreportuserid = $this->progressreportuserid;
        ...
        $lessondates = $DB->get_records('progressreport_user_lesson',['progressreportuserid' => $this->progressreportuserid]);
        $userdatas = $this->get_progressreportdata();
