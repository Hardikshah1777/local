...
class section implements renderable, templatable{
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $section->id = $this->id;
        $id = $this->moduleid;
        $editsection = new moodle_url('/mod/progressreport/editsection.php',['id'=>$id,'sectionid'=>$this->id]);
        $addskill = new moodle_url('/mod/progressreport/skill.php',['id'=>$id,'sectionid'=>$this->id]);
        $section->editurl = $editsection;

        $deletesec = new confirm_action(get_string('sectionmessage','mod_progressreport'));
        $deletesecurl = new moodle_url('/mod/progressreport/manage.php',['id'=>$id,'sectionid'=>$section->id]);
