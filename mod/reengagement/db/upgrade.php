...
function xmldb_reengagement_upgrade($oldversion=0) {
    ...
    if ($oldversion < 2022102900.01) {

        // Changing type of field suppresstarget on table reengagement to char.
        $table = new xmldb_table('reengagement');
        $field = new xmldb_field('suppresstarget', XMLDB_TYPE_CHAR, '10', null, XMLDB_NOTNULL, null, '0', 'remindercount');

        // Launch change of type for field suppresstarget.
        $dbman->change_field_type($table, $field);

        // Reengagement savepoint reached.
        upgrade_mod_savepoint(true, 2022102900.01, 'reengagement');
    }
