...
class mod_resource_mod_form extends moodleform_mod {
    function definition() {
        ...
        $mform->addElement('text','activityid', get_string('fileactivityid', 'resource'),'maxlength="100"  size="10"');
        $mform->setType('activityid', PARAM_RAW);

        $options = ['optional' => true];
        $mform->addElement('duration','retakeduration', get_string('retakeduration', 'resource'), $options);
