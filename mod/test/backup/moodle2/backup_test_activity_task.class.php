 ...
 */
class backup_test_activity_task extends backup_activity_task {
    ...
    protected function define_my_steps() {
        $this->add_step(new backup_test_activity_structure_step('test_structure', 'test.xml'));
    }
    ...
    public static function encode_content_links($content) {
        ...
        $content = preg_replace($search, '$@TESTVIEWBYID*$2@$', $content);
