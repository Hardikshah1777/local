...
$isweekend = optional_param('isweekend', 1, PARAM_INT);

$url = new moodle_url('/report/behaviour/weekly.php', ['id' => $courseid]);
...
$PAGE->set_url($url);
$PAGE->set_heading(get_string('weeklyheader', util::COMPONENT));
$PAGE->set_title(get_string('weeklytitle', util::COMPONENT));
...
if ($download) {
    ...
    ob_clean();
    util::export_excel($table, 'Weekly report');
}
