...
(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    define(["jquery", "theme_boost/bootstrap/index"], function (a0) {
      if (!([...document.styleSheets].some(i => i.href && i.href.indexOf('bootstrap-select') > 0))) {
        const head = document.querySelector('head');
        head?.appendChild(Object.assign(document.createElement('link'), {
          rel: 'stylesheet', type: 'text/css',
          href: `${M.cfg.wwwroot}/theme/jquery.php/theme_boost/bootstrap-select-1.13.14/css/bootstrap-select.min.css`
        }))
      }
      return (factory(a0));
    });
