    ...
    public function context_header($headerinfo = null, $headinglevel = 1): string {
        ...
        if ($context->contextlevel == CONTEXT_MODULE) {
            if ($this->page->course->format === 'singleactivity') {
                ...
                if (strpos($this->page->cm->get_icon_url(), 'activityicon') !== false) {
                    $purposeclass .= ' customiconcontainer';
                    $imagedata = html_writer::img($this->page->cm->get_icon_url(), $this->page->activityname, ['class' => 'activityicon']);
                }
