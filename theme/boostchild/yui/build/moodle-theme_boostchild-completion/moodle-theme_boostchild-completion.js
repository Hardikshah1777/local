YUI.add('moodle-theme_boostchild-completion', function (Y, NAME) {


M.theme_boostchild = M.theme_boostchild || {completion: {}};

M.theme_boostchild.completion.init = function() {
    ...
    var toggle = function(e) {
        ...
        Y.use('io-base', function(Y) {
            Y.io(M.cfg.wwwroot+'/theme/boostchild/ajax/togglecompletion.php', cfg);
        });
    };
