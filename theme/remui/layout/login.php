...
$loginauth = $CFG->auth_instructions;
$cansignup = $CFG->registerauth == 'email' || !empty($CFG->registerauth);

$templatecontext['hasinstructions'] = !empty($loginauth) || $cansignup;
list($templatecontext['instructions'], $templatecontext['instructionsformat']) = external_format_text($loginauth, FORMAT_MOODLE,
