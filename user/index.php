...
//custom filter form
class customfilter_form extends moodleform{
...
$filterurl = new moodle_url('/user/index.php', ['id'=>$course->id]);
$filterform = new customfilter_form($filterurl, []);
if ($formdata = $filterform->get_data()) {
    $SESSION->filters['user/index'] = [];
    if (!empty($formdata->firstname)) {
        $SESSION->filters['user/index']['firstname'] = $formdata->firstname;
    }
    if (!empty($formdata->lastname)) {
        $SESSION->filters['user/index']['lastname'] = $formdata->lastname;
    }
}
if (!empty($SESSION->filters) && !empty($SESSION->filters['user/index'])) {
    $filterform->set_data($SESSION->filters['user/index']);
}
//end
